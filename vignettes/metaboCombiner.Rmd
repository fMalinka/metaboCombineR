...
```{r getRTs and getMZs}
mzs <- getMZs(metaboExp1, mzprecision = 2)
...
sortedRTdf <- sortDataFrameByRt(metaboExp1, mzprecision = 2)
head(sortedRTdf)
```
...
sortedMZdf <- sortDataFrameByMz(metaboExp1, mzprecision = 2)
head(sortedMZdf)
```
